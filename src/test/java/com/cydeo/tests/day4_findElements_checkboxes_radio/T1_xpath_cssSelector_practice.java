...
public class T1_xpath_cssSelector_practice {
    ...
    public static void main(String[] args) {
        ...
        //d. E-mail input box
        WebElement inputBo_ex1 = driver.findElement(By.xpath("//input[@name='email']"));

        //Locate inputBox using xpath contains method

        //tagName[contains(@attribute,'value')]
        WebElement inputBo_ex2 = driver.findElement(By.xpath("//input[contains(@pattern,'a-z')]"));
        ...
        System.out.println("inputBo_ex1.isDisplayed() = " + inputBo_ex1.isDisplayed());
